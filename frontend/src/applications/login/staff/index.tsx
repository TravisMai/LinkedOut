  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      <Grid
        ...
        component="main"
        sx={{ height: "auto" }}
        className="justify-center items-center my-auto absolute top-0 bottom-0 left-0 right- bg-[url(https://thesaigontimes.vn/wp-content/uploads/2023/02/khoa-hoc-va-ky-thuat-may-tinh-1.jpg)] bg-cover"
      >
        <CssBaseline />
        <Grid
          item
