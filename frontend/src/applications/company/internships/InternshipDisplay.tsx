          ...
          >
            ...
            <Typography variant="body2" className="pl-5">
              ...
              <span className="font-bold">
                {internship?.jobApplicants?.student.name}{" "}
              </span>{" "}
            </Typography>
            <Typography variant="body2" className="pl-5">
              <Fingerprint /> Student ID:{" "}
              <span className="font-bold">
                {internship?.jobApplicants?.student.studentId}{" "}
              </span>
            </Typography>
            <Typography variant="body2" className="pl-5">
              <Email /> Email:{" "}
              <span className="font-bold">
                {internship?.jobApplicants?.student.email}{" "}
              </span>
            </Typography>
            <Typography variant="body2" className="pl-5">
              <Phone /> Phone:{" "}
              <span className="font-bold">
                {internship?.jobApplicants?.student.phoneNumber}{" "}
              </span>
            </Typography>
            <Typography variant="body2" className="pl-5">
              <Star /> Major:{" "}
              <span className="font-bold">
                {internship?.jobApplicants?.student.major}{" "}
              </span>
            </Typography>
            <Typography variant="body2" className="pl-5">
              <CalendarMonth /> Year:{" "}
              <span className="font-bold">
                {internship?.jobApplicants?.student.year}{" "}
              </span>
            </Typography>
            <Container
              disableGutters={true}
            ...
            >
              <Button
                ...
                color="primary"
                sx={{}}
                href={"/company/applicant/" + internship?.jobApplicants.id}
                size="large"
              >
                View full profile
              </Button>
                ...
                <List>
                  {internship?.jobApplicants?.resume.title ? (
                    <ListItem>
                      ...
                      <Link
                        href={
                          "/company/jobs/" + internship?.jobApplicants?.job.id
                        }
                      >
                        <ListItemText
                ...
                <List>
                  {internship?.result ? (
                    <ListItem>
                      ...
                      <ListItemText primary={internship?.result} />
                    </ListItem>
                  ) : (
                    <>No result set</>
                  )}
