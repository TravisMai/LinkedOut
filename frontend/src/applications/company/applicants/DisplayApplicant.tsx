import { AccountCircle, AttachFile, CalendarMonth, Email, Facebook, Fingerprint, GitHub, Google, Group, LinkedIn, More, Phone, School, Star, Twitter, WorkHistory, WorkspacePremium } from "@mui/icons-material";
import { Box, Container, Grid, Link, List, ListItem, ListItemIcon, ListItemText, Paper, Typography } from "@mui/material";
            ...
            <Grid container spacing={2} className='bg-[#f3f2f0] min-h-screen' sx={{ mt: 1 }}>
                <Grid item xs={3}>
                    <Container disableGutters={true}
                        ...
                        <Typography variant="body2" className='pl-5'> <AccountCircle /> Name: <span className="font-bold">{applicant?.student.name} </span> </Typography>
                        <Typography variant="body2" className='pl-5'><Fingerprint /> Student ID: <span className="font-bold">{applicant?.student.studentId} </span></Typography>
                        <Typography variant="body2" className='pl-5'><Email /> Email: <span className="font-bold">{applicant?.student.email} </span></Typography>
                        <Typography variant="body2" className='pl-5'><Phone /> Phone: <span className="font-bold">{applicant?.student.phoneNumber} </span></Typography>
                        <Typography variant="body2" className='pl-5'><Star /> Major: <span className="font-bold">{applicant?.student.major} </span></Typography>
                        <Typography variant="body2" className='pl-5'><CalendarMonth /> Year: <span className="font-bold">{applicant?.student.year} </span></Typography>
                        <Container disableGutters={true}
                            sx={{
                                alignContent: "center",
                                display: 'flex',
                ...
                <Grid item xs={8.8}>
                    <Container disableGutters={true}
                                    ...
                                    {applicant?.resume.title ?
                                        <ListItem>
                                            ...
                                            <Link href={applicant?.resume.url}>
                                                <ListItemText
                                                    primary={applicant?.resume.title}
                                                />
                                            </Link>
                                        </ListItem>
                                        : <></>
                                ...
                                <List>
                                    {applicant?.student?.socialMedia?.github ?
                                        <ListItem>
                                            ...
                                            <Link href={applicant?.student?.socialMedia?.github} target="_blank">{applicant?.student?.socialMedia?.github}</Link>
                                        </ListItem>
                                        : <></>
                                    }
                                    {applicant?.student?.socialMedia?.linkedin ?
                                        <ListItem>
                                            ...
                                            <Link href={applicant?.student?.socialMedia?.linkedin} target="_blank">{applicant?.student?.socialMedia?.linkedin}</Link>
                                        </ListItem>
                                        : <></>
                                    }
                                    {applicant?.student?.socialMedia?.facebook ?
                                        <ListItem>
                                            ...
                                            <Link href={applicant?.student?.socialMedia?.facebook} target="_blank">{applicant?.student?.socialMedia?.facebook}</Link>
                                        </ListItem>
                                        : <></>
                                    }
                                    {applicant?.student?.socialMedia?.google ?
                                        <ListItem>
                                            ...
                                            <Link href={applicant?.student?.socialMedia?.google} target="_blank">{applicant?.student?.socialMedia?.google}</Link>
                                        </ListItem>
                                        : <></>
                                    }
                                    {applicant?.student?.socialMedia?.twitter ?
                                        <ListItem>
                                            ...
                                            <Link href={applicant?.student?.socialMedia?.twitter} target="_blank">{applicant?.student?.socialMedia?.twitter}</Link>
                                        </ListItem>
                                        : <></>
                                    }
                        ...
                        <Paper>
                            ...
                            <Typography variant="body2" sx={{ pl: 2, pb: 2 }}>
                                <List>
                                    {applicant?.student?.education ? applicant?.student?.education.map((item) => (
                                        <ListItem>
                        ...
                        <Paper>
                            ...
                            <Typography variant="body2" sx={{ pl: 2, pb: 2 }}>
                                <List>
                                    {applicant?.student?.workingHistory ? applicant?.student?.workingHistory.map((item) => (
                                        <ListItem>
                        ...
                        <Paper>
                            ...
                            <Typography variant="body2" sx={{ pl: 2, pb: 2 }}>
                                <List>
                                    {applicant?.student?.certificate ? applicant?.student?.certificate.map((item) => (
                                        <ListItem>
                        ...
                        <Paper>
                            ...
                            <Typography variant="body2" sx={{ pl: 2, pb: 2 }}>
                                <List>
                                    {applicant?.student?.skill ? applicant?.student?.skill.map((item) => (
                                        <ListItem>
                        ...
                        <Paper>
                            ...
                            <Typography variant="body2" sx={{ pl: 2, pb: 2 }}>
                                <List>
                                    {applicant?.student?.additionalInformation ? applicant?.student?.additionalInformation.map((item) => (
                                        <ListItem>
                        ...
                        <Paper>
                            ...
                            <Typography variant="body2" sx={{ pl: 2, pb: 2 }}>
                                <List>
                                    {applicant?.student?.reference ? applicant?.student?.reference.map((item) => (
                                        <ListItem>
