...
import { Alert, Box, Checkbox, Container, CssBaseline, FormControl, FormControlLabel, FormGroup, Grid, IconButton, TextField, ThemeProvider, Typography, createTheme } from '@mui/material';
...
export default function UpdateDialog({ jobId, state, onExit, onClose }: { jobId: string, state: boolean, onExit: () => void, onClose: () => void }) {
    ...
    const mutation = useMutation<ResponseType, ErrorType, updateForm>({
        ...
        mutationFn: (formData) => {
            ...
            return axios.put(`https://linkedout-hcmut.feedme.io.vn/api/v1/job/${jobId}`, formDataToSend, {
                headers: {
                    Authorization: `Bearer ${token}`,
                    ...
                    <Container component="main" maxWidth="lg" >
                        ...
                        >
                            ...
                            <Box component="form" onSubmit={handleSubmit} sx={{ mt: 3 }}>
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12}>
                                        <TextField
                                            ...
                                            value={formData?.descriptions?.responsibilities ? formData.descriptions.responsibilities.join(",") : ""}
                                            onChange={handleInputChange}
                                        />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField
                                            ...
                                            value={formData?.descriptions?.requirements ? formData.descriptions.requirements.join(",") : ""}
                                            onChange={handleInputChange}
                                        />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField
                                            ...
                                            value={formData?.descriptions?.benefits ? formData.descriptions.benefits.join(",") : ""}
                                            onChange={handleInputChange}
                                        />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField
                                            ...
                                            value={formData?.descriptions?.preferredQualifications ? formData.descriptions.preferredQualifications.join(",") : ""}
                                            onChange={handleInputChange}
                                        />
                                    </Grid>
                                ...
                                {showSuccess && <Alert sx={{ mb: 2 }} severity="success">Job updated successfully</Alert>}
