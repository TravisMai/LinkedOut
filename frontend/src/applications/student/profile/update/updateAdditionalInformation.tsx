...
import { Delete, Facebook, GitHub, Google, LinkedIn, More, Twitter } from '@mui/icons-material';
...
export default function UpdateAdditionalInformation({ onClose }: { onClose: () => void }) {
    const handleClose = () => {
        onClose();
    };
    ...
    const [formData, setFormData] = useState<{ additionalInformation: additionalInformationType[] }>({
                    ...
                    >
                        ...
                        <Box component="form" onSubmit={handleSubmit} sx={{ mx: 2, mt: 5, mb: 2 }}>
                            <Grid container spacing={2} justifyContent="center">
                                {formData.additionalInformation?.map((item: additionalInformationType, index) => (
                                    <Grid container direction='row' spacing={1} className='mt-3 mx-5 mb-6'>
                                        ...
                                        <Grid item xs={1}>
                                            ...
                                            <LoadingButton
                                                ...
                                                onClick={() => {
                                                    const updatedFormData = { ...formData };
                                                    updatedFormData.additionalInformation.splice(index, 1);
                                                    setFormData(updatedFormData);
                                                }}
                                            // sx={{ mt: 1, mb: 2 }}
                                            >
                                        ...
                                        <DividerWithText className='mt-5' text="" muiElementIcon={<More />} />
