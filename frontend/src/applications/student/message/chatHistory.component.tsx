...
const messages = [
  ...
  { id: 2, text: "Hi", user: "Byzocu" },
  {
    id: 3,
    text: "I want to apply to Fullstack Developer Intern position, can you show me the applying procees?",
    user: "Me",
  },
  { id: 4, text: "Sure, please fill in this form.", user: "Byzocu" },
  { id: 4, text: "https://youcannotapply.Byzocu.kintone.com", user: "Byzocu" },
  { id: 3, text: "Thanks! Can I have the JD of this position?", user: "Me" },
  { id: 2, text: "Yes, sure.", user: "Byzocu" },
];
