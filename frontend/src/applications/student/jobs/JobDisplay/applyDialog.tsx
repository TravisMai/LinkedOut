...
import { Box, Container, CssBaseline, FormControl, FormControlLabel, IconButton, Link, Radio, RadioGroup, Typography } from '@mui/material';
...
export default function ApplyDialog({ isApplied, chooseResume, state, onExit, onClose }: { isApplied: boolean, state: boolean, chooseResume: (resumeId: string) => void, onExit: () => void, onClose: () => void }) {
    // Exit is cancel
    const handleExit = () => {
        onExit();
    }
                ...
                {isApplied &&
                    ...
                    <Container component="main" style={{ width: "" }}>
                        ...
                        >
                            ...
                            <Box component="form" onSubmit={handleClose} sx={{ mx: 4, mt: 5, mb: 2 }}>
