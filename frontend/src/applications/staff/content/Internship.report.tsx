  ...
  return (
    <>
      <div className="mt-8 w-full mx-auto">
        <Typography variant="h5" className="text-center">Internship reports</Typography>
          ...
          <Table sx={{ minWidth: 650 }} aria-label="simple table">
            <TableHead>
              <TableRow>
                ...
                <TableCell align="center">Internship Report</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
                  ...
                  <TableCell align="center">
                    <Box sx={{ "& > :not(style)": { m: 0.1 } }}>
                      <Tooltip title="Internship Program">
                        {row?.document?.find(doc => doc.name === "Internship report") ? (
                          <IconButton
                            href={
                              // Get the link of the document named "Recuirtment result"
                              row?.document?.find(doc => doc.name === "Internship report")?.url ?? ""
                            }
                          >
                            <Download />
                          </IconButton>) : (
                          <Typography variant="body2" color="error">No internship report</Typography>
                        )}
                      </Tooltip>
                    </Box>
                  </TableCell>
